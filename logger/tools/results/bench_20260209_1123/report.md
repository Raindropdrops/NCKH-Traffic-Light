...
|------|----------------------|----------------------------|-------|---------------|-------|
| Case 1 | 0 | 110.0 | 100 | 100 | Baseline |
| Case 2 | 256 | 377.0 | 100 | 100 | Payload +256B (<=1KB expected) |
| Case 3 | 512 | 633.0 | 100 | 100 | Payload +512B (<=1KB expected) |
| Case 4 | 900 | 1021.0 | 100 | 100 | Payload +900B (<=1KB expected) |
| Case 5 | 1200 | 1321.0 | 100 | 100 | Oversize payload +1200B (expected reject/no-ack) |

## 4. Kết Quả Tổng Hợp

| Case | Sent | Recv | Loss% | Mean (ms) | Median | P95 | P99 | Max | Status | Lý do |
|------|------|------|-------|-----------|--------|-----|-----|-----|--------|------|
| Case 1 | 100 | 100 | 0.0% | 42.7 | 43.0 | 45.0 | 49.0 | 49.0 | PASS | - |
| Case 2 | 100 | 100 | 0.0% | 43.1 | 43.0 | 45.0 | 47.0 | 47.0 | PASS | - |
| Case 3 | 100 | 100 | 0.0% | 42.9 | 43.0 | 45.0 | 46.0 | 46.0 | PASS | - |
| Case 4 | 100 | 100 | 0.0% | 43.0 | 43.5 | 45.0 | 45.0 | 45.0 | PASS | - |
| Case 5 | 100 | 0 | 100.0% | N/A | N/A | N/A | N/A | N/A | PASS | Expected reject/no-ack (oversize) |
...
- RTT mean: 42.7ms → 43.0ms (↑ 0.6% — tăng nhẹ)
