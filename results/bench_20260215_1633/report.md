...
|------|----------------------|----------------------------|-------|---------------|-------|
| Case 1 | 0 | 110.0 | 20 | 200 | Baseline |
| Case 2 | 256 | 377.0 | 20 | 200 | Payload +256B (<=1KB expected) |
| Case 3 | 512 | 633.0 | 20 | 200 | Payload +512B (<=1KB expected) |
| Case 4 | 900 | 1021.0 | 20 | 200 | Payload +900B (<=1KB expected) |
| Case 5 | 1200 | 1321.0 | 20 | 200 | Oversize payload +1200B (expected reject/no-ack) |

## 4. Kết Quả Tổng Hợp

| Case | Sent | Recv | Loss% | Mean (ms) | Median | P95 | P99 | Max | Status | Lý do |
|------|------|------|-------|-----------|--------|-----|-----|-----|--------|------|
| Case 1 | 20 | 20 | 0.0% | 41.1 | 43.0 | 45.0 | 45.0 | 45.0 | PASS | - |
| Case 2 | 20 | 20 | 0.0% | 41.0 | 43.0 | 45.0 | 45.0 | 45.0 | PASS | - |
| Case 3 | 20 | 20 | 0.0% | 41.4 | 43.0 | 46.0 | 46.0 | 46.0 | PASS | - |
| Case 4 | 20 | 20 | 0.0% | 41.2 | 43.0 | 45.0 | 45.0 | 45.0 | PASS | - |
| Case 5 | 20 | 0 | 100.0% | N/A | N/A | N/A | N/A | N/A | PASS | Expected reject/no-ack (oversize) |
...
- RTT mean: 41.1ms → 41.2ms (↑ 0.2% — tăng nhẹ)
