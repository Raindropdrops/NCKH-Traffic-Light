...
|------|----------------------|----------------------------|-------|---------------|-------|
| Case 1 | 0 | 110.0 | 500 | 200 | Baseline |
| Case 2 | 256 | 377.0 | 500 | 200 | Payload +256B (<=1KB expected) |
| Case 3 | 512 | 633.0 | 500 | 200 | Payload +512B (<=1KB expected) |
| Case 4 | 900 | 1021.0 | 500 | 200 | Payload +900B (<=1KB expected) |
| Case 5 | 1200 | 1321.0 | 500 | 200 | Oversize payload +1200B (expected reject/no-ack) |

## 4. Kết Quả Tổng Hợp

| Case | Sent | Recv | Loss% | Mean (ms) | Median | P95 | P99 | Max | Status | Lý do |
|------|------|------|-------|-----------|--------|-----|-----|-----|--------|------|
| Case 1 | 500 | 500 | 0.0% | 43.3 | 43.0 | 45.0 | 47.0 | 49.0 | PASS | - |
| Case 2 | 500 | 500 | 0.0% | 43.2 | 43.0 | 45.0 | 46.0 | 49.0 | PASS | - |
| Case 3 | 500 | 500 | 0.0% | 43.3 | 43.0 | 45.0 | 46.0 | 48.0 | PASS | - |
| Case 4 | 500 | 500 | 0.0% | 43.4 | 43.0 | 45.0 | 46.0 | 49.0 | PASS | - |
| Case 5 | 500 | 0 | 100.0% | N/A | N/A | N/A | N/A | N/A | PASS | Expected reject/no-ack (oversize) |
...
- RTT mean: 43.3ms → 43.4ms (↑ 0.0% — tăng nhẹ)
