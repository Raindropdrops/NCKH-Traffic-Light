...
|------|----------------------|----------------------------|-------|---------------|-------|
| Case 1 | 0 | 110.0 | 5 | 200 | Baseline |
| Case 2 | 256 | 377.0 | 5 | 200 | Payload +256B (<=1KB expected) |
| Case 3 | 512 | 633.0 | 5 | 200 | Payload +512B (<=1KB expected) |
| Case 4 | 900 | 1021.0 | 5 | 200 | Payload +900B (<=1KB expected) |
| Case 5 | 1200 | 1321.0 | 5 | 200 | Oversize payload +1200B (expected reject/no-ack) |

## 4. Kết Quả Tổng Hợp

| Case | Sent | Recv | Loss% | Mean (ms) | Median | P95 | P99 | Max | Status | Lý do |
|------|------|------|-------|-----------|--------|-----|-----|-----|--------|------|
| Case 1 | 5 | 5 | 0.0% | 35.0 | 43.0 | 44.0 | 44.0 | 44.0 | PASS | - |
| Case 2 | 5 | 5 | 0.0% | 34.8 | 42.0 | 45.0 | 45.0 | 45.0 | PASS | - |
| Case 3 | 5 | 5 | 0.0% | 35.2 | 42.0 | 45.0 | 45.0 | 45.0 | PASS | - |
| Case 4 | 5 | 5 | 0.0% | 33.4 | 41.0 | 42.0 | 42.0 | 42.0 | PASS | - |
| Case 5 | 5 | 0 | 100.0% | N/A | N/A | N/A | N/A | N/A | PASS | Expected reject/no-ack (oversize) |
...
- RTT mean: 35.0ms → 33.4ms (không đổi hoặc giảm)
